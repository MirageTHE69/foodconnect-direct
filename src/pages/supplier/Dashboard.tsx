...
import { Package, UtensilsCrossed, Building2, MessageSquare, AlertCircle } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div>
          ...
          <p className="text-muted-foreground">Manage your business from here.</p>
        </div>
